...
import 'list_pharm_users_model.dart';
export 'list_pharm_users_model.dart';

class ListPharmUsersWidget extends StatefulWidget {
  const ListPharmUsersWidget({
    super.key,
  ...
  @override
  State<ListPharmUsersWidget> createState() => _ListPharmUsersWidgetState();
}

class _ListPharmUsersWidgetState extends State<ListPharmUsersWidget> {
  late ListPharmUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListPharmUsersModel());
