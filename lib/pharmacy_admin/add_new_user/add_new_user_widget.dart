                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'ملحوظة: يجب أن يكون العميل لديه حساب على دوائي بالفعل',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.pharmDoc = await PharmaciesRecord
                                          .getDocumentOnce(currentUserDocument!
                                              .adminOfPharmacy!);
                                      shouldSetState = true;
                                      if (_model.pharmDoc?.linkedPatients
                                              .contains(_model
                                                  .foundUser?.patientRef) ==
                                          false) {
                                        _model.linkOutput = await actions
                                            .linkPharmacyAndPatient(
                                          currentUserDocument!.adminOfPharmacy!,
                                          _model.foundUser!.reference,
                                          _model.pathDoc!.reference,
                                        );
                                        shouldSetState = true;
                                        if (_model.linkOutput!) {
                                    ...
                                    text:
                                        'تأكيد البيانات وأضافة العميل للصيدلية',
                                    options: FFButtonOptions(
