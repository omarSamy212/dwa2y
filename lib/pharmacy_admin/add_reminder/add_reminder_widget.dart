...
class _AddReminderWidgetState extends State<AddReminderWidget>
  ...
  void initState() {
    ...
    _model.fullAddressTextController1 ??= TextEditingController();
    _model.fullAddressFocusNode1 ??= FocusNode();

    _model.fullAddressTextController2 ??= TextEditingController();
    _model.fullAddressFocusNode2 ??= FocusNode();

    _model.fullAddressTextController3 ??= TextEditingController();
    _model.fullAddressFocusNode3 ??= FocusNode();

    _model.fullAddressTextController4 ??= TextEditingController();
    _model.fullAddressFocusNode4 ??= FocusNode();
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.fullAddressTextController1,
                                    focusNode: _model.fullAddressFocusNode1,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      '_model.fullAddressTextController1',
                                      const Duration(milliseconds: 2000),
                                      () => safeSetState(() {}),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.fullAddressTextController2,
                                    focusNode: _model.fullAddressFocusNode2,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      '_model.fullAddressTextController2',
                                      const Duration(milliseconds: 2000),
                                      () => safeSetState(() {}),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.fullAddressTextController3,
                                    focusNode: _model.fullAddressFocusNode3,
                                    onChanged: (_) => EasyDebounce.debounce(
                                      '_model.fullAddressTextController3',
                                      const Duration(milliseconds: 2000),
                                      () => safeSetState(() {}),
                                    ...
                                    validator: _model
                                        .fullAddressTextController3Validator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.fullAddressTextController4,
                                      focusNode: _model.fullAddressFocusNode4,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.fullAddressTextController4',
                                        const Duration(milliseconds: 2000),
                                        () => safeSetState(() {}),
                                      ...
                                      validator: _model
                                          .fullAddressTextController4Validator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
