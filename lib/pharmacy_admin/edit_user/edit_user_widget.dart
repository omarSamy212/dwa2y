...
class EditUserWidget extends StatefulWidget {
  ...
  final PatientsRecord? patientDoc;
...
class _EditUserWidgetState extends State<EditUserWidget> {
  ...
  void initState() {
    ...
    _model.nameTextController ??=
        TextEditingController(text: widget.patientDoc?.name);
    _model.nameFocusNode ??= FocusNode();

    _model.phoneTextController ??=
        TextEditingController(text: widget.patientDoc?.phone);
    _model.phoneFocusNode ??= FocusNode();

    _model.ageFocusNode ??= FocusNode();

    _model.locationTextController ??=
        TextEditingController(text: widget.patientDoc?.notes);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.patientDoc!.userRef!),
      builder: (context, snapshot) {
        ...
        final editUserUsersRecord = snapshot.data!;
                                  ...
                                  children: [
                                    TextFormField(
                                      controller: _model.emailTextController ??=
                                        ...
                                        text: editUserUsersRecord.email,
                                      ),
                                ...
                                return Dialog(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: ConfirmationDialougeWidget(
                                      ...
                                      yesAction: () async {
                                        if (widget.patientDoc != null) {
                                          await widget.patientDoc!.userRef!
