...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'pills_Details',
          path: '/pillsDetails',
          builder: (context, params) => const PillsDetailsWidget(),
        ),
        FFRoute(
          name: 'User_Profile',
          path: '/userProfile',
        ...
        FFRoute(
          name: 'PharmaS_List',
          path: '/pharmaSList',
          builder: (context, params) => const PharmaSListWidget(),
        ),
        FFRoute(
          name: 'Add_reminder',
          path: '/addReminder',
        ...
        FFRoute(
          name: 'phramDetails',
          path: '/phramDetails',
          builder: (context, params) => PhramDetailsWidget(
        ...
        FFRoute(
          name: 'add_pharm',
          path: '/addPharm',
          builder: (context, params) => const AddPharmWidget(),
        ),
        FFRoute(
          name: 'Default_Login',
          path: '/defaultLogin',
