...
import 'add_pharm_user_model.dart';
export 'add_pharm_user_model.dart';

class AddPharmUserWidget extends StatefulWidget {
  ...
  const AddPharmUserWidget({
    super.key,
    required this.pharmRef,
  });

  final DocumentReference? pharmRef;

  @override
  State<AddPharmUserWidget> createState() => _AddPharmUserWidgetState();
}

class _AddPharmUserWidgetState extends State<AddPharmUserWidget> {
  late AddPharmUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPharmUserModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Text(
                                    'ملحوظة: هذا البريد الالكتروني سيستخدم في الدخول لحساب العميل لاحقا.',
                                    style: FlutterFlowTheme.of(context)
                                        .headlineSmall
                                        .override(
                                          fontFamily: 'Noto Sans Arabic',
                                ...
                                Align(
                                  alignment: const AlignmentDirectional(-1.0, 0.0),
                                  child: Text(
                                    'ملحوظة:  سيستخدم رقم الهاتف ككلمة مرور  في الدخول لحساب العميل لاحقا.',
                                    style: FlutterFlowTheme.of(context)
                                        .headlineSmall
                                        .override(
                                          fontFamily: 'Noto Sans Arabic',
                            ...
                            return Dialog(
                              ...
                              child: GestureDetector(
                                ...
                                child: ConfirmationDialougeWidget(
                                  message: 'هل أنت متأكد من أضافة هذا العميل ؟',
                                  yesAction: () async {
                                    var shouldSetState = false;
                                    _model.userDocRef =
                                        await actions.createPatient(
                                    ...
                                    if (_model.userDocRef != null) {
                                      ...
                                      await _model.userDocRef!
                                        ...
                                        patientRef:
                                            _model.patientDocRef?.reference,
                                      ));

                                      await widget.pharmRef!.update({
                                        ...mapToFirestore(
                                          {
                                            'linkedPatients':
